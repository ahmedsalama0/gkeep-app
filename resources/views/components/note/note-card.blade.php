@foreach ($notes as $note)
    <div class="col-xxl-3 col-md-6 col-xl-4">
        {{-- <div class="single_note" style="background-color: {{ $note->color_name ?? '' }}"> --}}
        {{-- <div class="single_note" {{ $note->color_name ? "style=background:{$note->color_name}" : '' }}> --}}
        <div class="single_note" {{-- {{ $note->appearance_type == 'color' ? "style=background:{$note->color_name}" : "style=background-image:url({asset($note->image_path)})" }} --}}
            ...
            <div class="ions_area">
                <ul>
                    <li>
                        ...
                        <div class="theme_area">
                            <ul class="theme_color">
                                ...
                                {{-- we've created appearance.php in config to have all the colors we do need. --}}
                    ...
                    <li>
                        ...
                        <ul class="drop_list">
                            <li><a href="javascript:;" onclick="$('.delete-note-{{ $note->id }}').submit()">delete
                                    note</a></li>
                            @if ($trash)
    ...
    <div class="custom_modal_area" data-modal="modal_{{ $note->id }}">
        <div class="custom_modal_content"
            ...
            <form action="{{ route('notes.update', $note->id) }}" method="POST"
                ...
                {{-- <input type="text" placeholder="Note" name="content" value="{{ $note->content }}"> --}}
                {{-- <textarea rows="4" placeholder="Note" id="editorjs" name="content">
                    {!! $note->content !!}
                </textarea> --}}
                <textarea rows="4" placeholder="Note" name="content">
                    {!! $note->content !!}
                </textarea>
            </form>
            <div class="ions_area">
                ...
                <a class="" href="javascript:;"
                    onclick="$('.update-note-{{ $note->id }}').submit();">Save</a>
